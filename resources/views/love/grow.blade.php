    ...
    <div class="container mx-auto flex justify-center flex-wrap">
        ...
        <div class="w-full md:w-1/2 flex justify-center py-2 border-2 my-2">
            <div class="w-full px-4 py-4 flex flex-col items-center">
                ...
                <div class="w-70p py-2">
                    <img src="/images/placeholder.png" class="w-full h-full object-cover" alt="">
                </div>
        ...
        <div class="w-full md:w-1/2 flex justify-center py-2 border-2 my-2">
            <div class="w-full px-4 py-4 flex flex-col items-center">
                <h2 class="bg-green text-grey-lightest text-4xl px-4 py-2 text-center w-full max-h-full">Polytunnel</h2>
                <div class="w-70p py-2">

...
<div class="bg-neutral-2">
    <div class="container mx-auto">
        <h2 class="text-center text-4xl py-6">Your Support Helps Our Animals</h2>
    </div>
    <div class="container mx-auto flex flex-wrap justify-center">
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-left" data-aos-once="true" data-aos-duration="1000">
                ...
                <h5 class="bg-grey text-grey-darkest text-center py-2 text-xl">Mixed Breed Goat</h5>
                <p class="leading-normal py-2 px-1 h-full bg-neutral-1">Coco has been our biggest challenge, she really was scared when she arrived. She didn't trust humans but after lots of love and care. Coco has settled into the farm and has become one confident lady.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-right" data-aos-once="true" data-aos-duration="1000">
                ...
                <h5 class="bg-grey text-grey-darkest text-center py-2 text-xl">Mixed Breed Goat</h5>
                <p class="leading-normal py-2 px-1 h-full bg-neutral-1">Twink was quite wild too but her love of treats, especially sweet things made her a very friendly goat. She loves to play and dance.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
                ...
                <h5 class="bg-wine text-grey-lightest text-center py-2 text-xl">Silkie Hen</h5>
                <p class="leading-normal py-2 px-1 h-full bg-neutral-1">Our delicate and fluffy chickens are the most watchful bunch. They always watch out for each other. Henry has taken to staying close to the ladies and protecting them from any perceived danger. That's our Silkie family.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-left" data-aos-once="true" data-aos-duration="1000">
                ...
                <h5 class="bg-wine text-grey-lightest text-center py-2 text-xl">Silkie Cockerel</h5>
                <p class="leading-normal py-2 px-1 h-full bg-neutral-1">Our delicate and fluffy chickens are the most watchful bunch. They always watch out for each other. Henry has taken to staying close to the ladies and protecting them from any perceived danger. That's our Silkie family.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
                ...
                <h5 class="bg-fair text-grey-darkest text-center py-2 text-xl">Guinea Pig</h5>
                <p class="leading-normal py-2 px-1 h-full bg-neutral-1">Even though she's small, she's fierce. She makes sure to squeak loudly in the morning to make sure we know she's there and ready for her breakfast. She absolutely loves fresh grass and loves to watch Nomah (rabbit) play. They share a stable together.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-left" data-aos-once="true" data-aos-duration="1000">
                ...
                <p class="leading-normal py-2 px-1 h-full bg-neutral-1">Nomah is a happy rabbit with beautiful soft fur. She loves to jump on the straw bails in her stable and loves apples. She is self-confident and teaches us to be happy.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-right" data-aos-once="true" data-aos-duration="1000">
                ...
                <p class="leading-normal py-2 px-1 h-full bg-neutral-1">Our five beautiful ladies came to the farm quiet wild. Only one (Blonde) allowed us to pick her up but now one of their favorite things they love to do is to be cuddled. They are five feisty ladies that keep us entertained at the farm with their very different personalities.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/3 flex justify-center my-4">
            <div class="w-80p flex flex-col justify-center border-2 animals" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">

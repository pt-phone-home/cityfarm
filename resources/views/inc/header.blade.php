<div class="w-full py-2 px-3 h-32 flex  bg-grey-lightest justify-center items-center z-100 relative font-dec">
    <div class="flex flex-row justify-between container mx-auto sm:w-100p md:w-100p lg:w-70p">
        ...
        <div class="flex justify-end md:justify-between items-center w-2/3" id="nav">
            ...
            <a href="{{route('index')}}" class="hidden md:inline-block text-grey-darkest no-underline hover:text-primary-8 text-2xl">Our Community</a>
                    <div class="dropdown-content flex flex-col absolute pin-t mt-8 w-48 pt-1 px-8 mt-1 bg-grey-lightest rounded">
                    <a href={{route('about')}} class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl"><object data="/images/divider.svg" type="image/svg+xml" class="w-6 hidden group-hover:block fill-current h-auto"></object> About US</a>
                    {{-- <a href="{{route('classes')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Classes</a> --}}
                    {{-- <a href="{{route('kitchen')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Community Kitchen</a> --}}
                    <a href="{{route('education')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Education</a>
                    <a href="{{route('calendar')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Farm Calendar</a>
                    </div>
            </li>
            <li class="list-reset dropdown">
            <a href="{{route('animals')}}" class="hidden md:inline-block text-grey-darkest no-underline hover:text-primary-8 text-2xl">Love</a>
                    <div class="dropdown-content flex flex-col absolute pin-t w-48 mt-8 pt-1 px-8 bg-grey-lightest rounded">
                    <a href="{{route('animals')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Animals</a>
                    <a href="{{route('grow')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Grow</a>
                    <a href="{{route('ecology')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Ecology</a>
                    </div>
            </li>
            <li class="list-reset dropdown">
            <a href="{{route('volunteer')}}" class="hidden md:inline-block text-grey-darkest no-underline hover:text-primary-8 text-2xl dropdown">Get Involved</a>
                    <div class="dropdown-content flex flex-col absolute pin-t w-48 mt-8 pt-1 px-8 bg-grey-lightest rounded">
                    <a href="{{route('volunteer')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Volunteer</a>
                    <a href="{{route('corporate')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Corporate</a>
                    <a href="{{route('sponsors')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Sponsors</a>
                    <a href="{{route('donate')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Donate</a>
                    </div>
            </li>
            <li class="list-reset">
            <a href="{{route('news')}}" class="hidden md:inline-block text-grey-darkest no-underline hover:text-primary-8 text-2xl">News</a>
            </li>
            <li class="list-reset dropdown">
                <a href="{{route('info.visit_us')}}" class="hidden md:inline-block text-grey-darkest no-underline hover:text-primary-8 text-2xl dropdown">Info</a>
                <div class="dropdown-content flex flex-col absolute pin-t pin-r -mr-10 w-48 mt-8 pt-1 px-8 bg-grey-lightest rounded">
                    <a href="{{route('info.visit_us')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Visit Us</a>
                <a href="{{route('info.contact')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Contact Us</a>
                <a href="{{route('info.safety')}}" class="py-1 no-underline text-grey-darkest hover:text-primary-8 text-xl">Farm Safety</a>
                </div>
            </li>
            <li class="list-reset">
                <button class="sm:inline-block md:hidden text-grey-darkest no-underline hover:text-primary-8 text-2xl"><i class="fas fa-bars text-grey-darkest text-3xl" id="navBtn"></i></button>
            </li>
        </div>
    </div>
</div>
{{-- Mobile Nav Bar --}}
<div class="fixed pin-t pin-l bg-green z-30 hidden justify-center z-100 py-4" id="mobNav">

...
@section('content')
<div class="bgi-farm h-5r md:h-7r lg:h-10r flex justify-center items-center">
    <h1 class="font-dec text-grey-darkest text-3xl md:text-5xl xl:text-6xl">About Us</h1>
</div>
<div class="bg-primary-8">
    <div class="container mx-auto">
        <div class="px-12 py-12">
            <p class="leading-loose text-neutral-2 text-center mx-auto sm:w-90p md:w-80p lg:w-50p leading-loose text-lg md:text-xl lg:text-2xl">St. Anne's City Farm is a community space that is open 5 days a week and is free for everyone. So come get involved or come spend time at a beautiful city sanctuary. </p>
